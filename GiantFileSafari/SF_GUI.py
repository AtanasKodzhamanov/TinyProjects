...
tk.Label(window, text="",bg="#E6E6E6", padx=10, pady=10).grid(row=1, column=0, columnspan=3)

# Create input fields for the path, output, minimum size, and top values
tk.Label(window, text="Path - the location of the folder to be analysed:", font=("Verdana", 11),bg="#E6E6E6", fg="black").grid(row=2, column=0)
path = tk.StringVar()
e1 = tk.Entry(window, textvariable=path, font=("Verdana", 11), bg="white")
e1.grid(row=2, column=1, padx=10, pady=10)

tk.Label(window, text="Output folder - the location of the final report:", font=("Verdana", 11),bg="#E6E6E6", fg="black").grid(row=3, column=0)
output = tk.StringVar()
e2 = tk.Entry(window, textvariable=output, font=("Verdana", 11), bg="white")
e2.grid(row=3, column=1, padx=10, pady=10)

tk.Label(window, text="Minimum size of file (GB):", font=("Verdana", 11),bg="#E6E6E6", fg="black").grid(row=4, column=0)
...
tk.Label(window, text="Top - largest files to list in the report:", font=("Verdana", 11), bg="#E6E6E6", fg="black").grid(row=5, column=0)
top = tk.IntVar()
